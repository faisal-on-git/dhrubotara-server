class Account < ApplicationRecord
  ...
  validates :account_type, presence: true, inclusion: { in: %w[checking savings credit_card loan investment cash] }
  validates :balance, presence: true, numericality: true
  validates :category, presence: true, inclusion: { in: %w[asset liability] }
